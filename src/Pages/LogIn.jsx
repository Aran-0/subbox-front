  ...
  return (
    <div className="relative flex max-lg:flex-col-reverse justify-center md:justify-start xl:justify-center items-center gap-12 lg:mt-28 xl:gap-24">
      ...
      <div className="flex flex-col gap-6 md:gap-8 md:mx-10 items-center sm:items-start max-lg:mt-40 justify-center">
        ...
        <div className="mt-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg w-72 md:w-96">
          <p className="text-sm font-medium text-indigo-900 mb-3">
            🔐 Демо Админ Аккаунт:
          </p>
          <div className="text-xs text-indigo-800 space-y-1 mb-3">
            <p>Email: <code className="bg-white px-2 py-1 rounded">admin@subbox.com</code></p>
            <p>Password: <code className="bg-white px-2 py-1 rounded">Admin@123</code></p>
          </div>
          <button
            type="button"
            onClick={() => {
              setEmail("admin@subbox.com");
