...
const Footer = () => {
  ...
  return (
    <footer className="hidden bg-gradient-to-br from-slate-800 via-slate-900 to-cyan-900 text-white py-12 mt-24 bottom-0 w-full shadow-2xl border-t-2 border-cyan-500/20">
      <Container>
        <Grid
          container
          direction="row"
        ...
        >
          ...
          >
            <Typography className="font-bold bg-gradient-to-r from-sky-400 to-cyan-400 bg-clip-text text-transparent" variant="h6" gutterBottom>
              Subbox
            </Typography>
          ...
          >
            ...
            <Typography variant="body2">subbox@gmail.com</Typography>
