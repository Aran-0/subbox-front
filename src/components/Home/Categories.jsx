...
const Category = ({ icon, name, categoryName }) => (
  <Link to="/category" state={{ category: categoryName }}>
    <button
      onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
      className="w-full flex gap-4 items-center justify-center flex-col bg-white py-6 px-4 rounded-lg border border-gray-100 shadow-sm transition-transform duration-300 hover:shadow-lg hover:-translate-y-2"
    >
      <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-sky-50 to-cyan-50 flex items-center justify-center mb-3">
        <div className="text-sky-600">{icon}</div>
      </div>
      <div className="text-lg font-semibold text-gray-800">{name}</div>
      <div className="text-sm text-gray-500 mt-1">{i18n.t("redButtons.exploreByCategory")}</div>
    </button>
  </Link>
);
  ...
  const categories = [
    {
      ...
      name: i18n.t("homeSections.row1.col1.0"),
      categoryName: i18n.t("homeSections.row1.col1.0"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.1"),
      categoryName: i18n.t("homeSections.row1.col1.1"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.2"),
      categoryName: i18n.t("homeSections.row1.col1.2"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.3"),
      categoryName: i18n.t("homeSections.row1.col1.3"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.4"),
      categoryName: i18n.t("homeSections.row1.col1.4"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.5"),
      categoryName: i18n.t("homeSections.row1.col1.5"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.6"),
      categoryName: i18n.t("homeSections.row1.col1.6"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.7"),
      categoryName: i18n.t("homeSections.row1.col1.7"),
    },
    {
      icon: (
        <svg
      ...
      name: i18n.t("homeSections.row1.col1.8"),
      categoryName: i18n.t("homeSections.row1.col1.8"),
    },
  ];
  ...
  return (
    <Grid container spacing={3} justifyContent="center" alignItems="center">
      {categories.map((category, index) => (
        <Grid item key={index} xs={6} sm={4} md={3} lg={3} xl={3}>
          <Category icon={category.icon} name={category.name} categoryName={category.categoryName} />
        </Grid>
      ))}
    </Grid>
  );
  ...
  return (
    <div className="px-4 py-12">
      ...
      <div className="flex gap-6 items-center justify-between mb-8">
        <h2 className="text-xl md:text-3xl font-semibold">{i18n.t("category.title")}</h2>
        <Arrows />
      </div>
      <CategoryList />
    </div>
