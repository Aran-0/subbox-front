...
const resources = {
  en: {
    translation: {
      ...
      slogan: "Subbox — everything you need, in one place",
  ...
  ru: {
    translation: {
      ...
      dir: "ltr",
      topHeader:
        "Летняя распродажа на все купальники и бесплатная экспресс‑доставка — СКИДКА 50%!",
      shop: "Купить",
      welcome: "Добро пожаловать в Subbox",
      slogan: "SubBox — всё, что тебе нужно, в одном месте",
      ...
      homeSections: {
        row1: {
          ...
          col2: ["Серия iPhone 14", "Скидка до 10%", "Купить сейчас"],
        },
        row2: ["Сегодня", "Молниеносные распродажи", "Дни", "Часы", "Минуты", "Секунды"],
      },
      ...
      itemsArray: {
        0: {
          ...
          type: "Игрушки",
          details:
            "Увлекательный электромобиль для детей — часы удовольствия и безопасной езды.",
        },
        1: {
          title: "CANON EOS DSLR камера",
          type: "Техника",
          details:
            "Профессиональная зеркальная камера Canon для потрясающих фото и видео.",
        },
        2: {
          title: "Сухой корм для собак",
          type: "Общее",
          details:
            "Питательный сухой корм для собак из качественных ингредиентов.",
        },
        3: {
          title: "ASUS FHD игровой ноутбук",
          type: "Техника",
          details:
            "Высокопроизводительный игровой ноутбук ASUS с мощной графикой.",
        },
        4: {
          title: "Набор ухода Curology",
          type: "Общее",
          details:
            "Полный набор по уходу за кожей — очищение, увлажнение и защита.",
        },
        5: {
          title: "Геймпад GP11 USB",
          type: "Игры",
          details:
            "USB‑геймпад GP11 с точным управлением для комфортных игровых сессий.",
        },
        6: {
          title: "Стёганая сатиновая куртка",
          type: "Одежда",
          details: "Стильная тёплая куртка — трендовый элемент гардероба.",
        },
        7: {
          title: "Небольшая книжная полка",
          type: "Общее",
          details: "Компактная полка для книг и декора — экономит место.",
        },
        8: {
          title: "RGB жидкостное охлаждение CPU",
          type: "Техника",
          details:
            "Производительное жидкостное охлаждение с RGB‑подсветкой для процессора.",
        },
        9: {
          title: "Дорожная сумка Gucci",
          type: "Одежда",
          details: "Стильная дорожная сумка из премиальных материалов.",
        },
        10: {
          title: "Пальто The North",
          type: "Одежда",
          details: "Тёплое и долговечное пальто с классическим дизайном.",
        },
        11: {
          title: "Геймпад HAVIT HV‑G92",
          type: "Игры",
          details: "Отзывчивый геймпад для длительных игровых сессий.",
        },
        12: {
          title: "Проводная клавиатура AK‑900",
          type: "Техника",
          details: "Надёжная проводная клавиатура с эргономичным дизайном.",
        },
        13: {
          title: "Игровой монитор IPS LCD",
          type: "Техника",
          details: "Яркий игровой монитор с плавной картинкой.",
        },
        14: {
          title: "Комфортное кресло S‑Series",
          type: "Одежда",
          details: "Эргономичное кресло с мягкой обивкой для долгого сидения.",
        },
        15: {
          title: "JBL Boombox 2",
          type: "Новинка",
          details: "Мощный портативный динамик с длительным временем работы.",
        },
        16: {
          title: "Парфюм",
          type: "Новинка",
          details:
            "Роскошный аромат с нотами уда, розы и ладан — стойкий и насыщенный.",
        },
        17: {
          title: "Смартфон",
          type: "Новинка",
          details: "Мощный смартфон с большим экраном и долгой батареей.",
        },
        18: {
          title: "PlayStation 5",
          type: "Новинка",
          details: "Черно‑белая версия PS5 скоро в продаже.",
        },
        19: {
          title: "Колонка",
          type: "Новинка",
          details: "Беспроводная колонка Amazon с отличным звуком.",
        },
        20: {
          title: "Женские коллекции",
          type: "Новинка",
          details: "Подборка женской одежды для особого настроения.",
        },
        21: {
          title: "Футбольные бутсы",
          type: "Новинка",
          details: "Лучшие бутсы для вашей игры — надёжность и комфорт.",
        },
      },
      categories: {
        general: "Общее",
      ...
      services: {
        0: {
          value: "БЕСПЛАТНАЯ И БЫСТРАЯ ДОСТАВКА",
          description: "Бесплатная доставка для заказов свыше $140",
        },
        1: {
          value: "КРУГЛОСУТОЧНАЯ ПОДДЕРЖКА",
          description: "Дружелюбная служба поддержки 24/7",
        },
        2: {
          value: "ГАРАНТИЯ ВОЗВРАТА ДЕНЕГ",
          description: "Возврат денег в течение 30 дней",
        },
      },
      redButtons: {
        viewAllProducts: "Показать все товары",
        viewAll: "Показать всё",
        exploreByCategory: "Исследовать по категориям",
        buyNow: "Купить сейчас",
        sendMassage: "Отправить сообщение",
        createAccount: "Создать аккаунт",
        login: "Войти",
        applyCoupon: "Применить купон",
        processToCheckout: "Перейти к оплате",
        placeOrder: "Оформить заказ",
        backToHomePage: "Вернуться на главную",
        chooseByCategory: "Выбрать по категории",
      },
      whiteButtons: {
        backToHomePage: "Вернуться на главную",
        loadMore: "Загрузить ещё..",
        moveAllToBag: "Переместить всё в корзину",
        seeAll: "Смотреть всё",
      ...
      productPage: {
        ...
        1.1: "Введите почтовый индекс для проверки доставки",
        2: "Возврат",
        2.1: "Бесплатный возврат в течение 30 дней",
      },
      contactPage: {
        call: "Связаться с нами",
        available: "Мы доступны 24/7, 7 дней в неделю.",
        phone: "Телефон",
        write: "Напишите нам",
        fillForm: "Заполните форму, и мы свяжемся с вами в течение 24 часов.",
      ...
      aboutPage: {
        ...
        story: "Наша история",
        paragraph1:
          "Запущен в 2015 году, Exclusive — ведущая платформа для онлайн‑шопинга в Южной Азии с активным присутствием в Бангладеш.",
        paragraph2:
          "Exclusive предлагает более миллиона товаров и быстро развивается, предоставляя разнообразные категории продуктов.",
        card1: "Продавцы, активные на сайте",
        card2: "Ежемесячные продажи товаров",
        card3: "Активные покупатели",
        card4: "Годовой оборот",
        k1: "10.5k",
        k2: "33k",
        k3: "45.5k",
        k4: "25k",
        ...
        name3: "Уилл Смит",
        name4: "Том Харди",
        job1: "Основатель и председатель",
        job2: "CTO",
        job3: "CEO",
        job4: "Дизайнер продукта",
      },
      accountPage: {
        setMassage: "Данные аккаунта успешно обновлены!",
      ...
      signUpPage: {
        ...
        enter: "Введите ваши данные ниже:",
        email: "Электронная почта",
        password: "Пароль",
        createAccount: "Создать аккаунт",
        withGoogle: "Регистрация через Google",
        haveAccount: "Уже есть аккаунт?",
        login: "Войти",
      },
      loginPage: {
        title: "Войти в Subbox",
        enter: "Введите ваши данные ниже:",
      ...
      Snackbar: {
        inCart: "Товары уже в корзине!",
        movedToCart: "Товары успешно перемещены в корзину!",
        noItems: "Нет товаров для перемещения в корзину!",
      },
      category: {
        redTitle: "Категории",
      ...
      bestSelling: {
        redTitle: "В этом месяце",
        title: "Хиты продаж",
      },
      deal: {
        greenTitle: "Категории",
        title: "Улучшите своё звучание",
        days: "Дни",
        hours: "Часы",
        minutes: "Минуты",
        seconds: "Секунды",
      ...
      allProducts: {
        redTitle: "Наши продукты",
        title: "Исследуйте наши товары",
        byCategory: "По категории",
      },
      featured: {
        redTitle: "Рекомендуем",
        title: "Новинки",
        shopNow: "Купить сейчас",
        playStation: {
          title: "PlayStation 5",
          description: "Чёрно‑белая версия PS5 скоро в продаже.",
        },
        WomenCollections: {
          title: "Женские коллекции",
          description: "Подборки женской одежды для особого стиля.",
        },
        speakers: {
          title: "Колонки",
          description: "Беспроводные колонки Amazon",
        },
        perfume: {
          title: "Парфюм",
          description: "GUCCI INTENSE OUD EDP",
      ...
      footer: {
        ...
        offer: "Получите 10% скидку на первый заказ",
        ...
        save: "Сэкономьте $3 с приложением (только для новых пользователей)",
        support: "Поддержка",
        address: "111 Bijoy sarani, Dhaka, DH 1515, Bangladesh",
        ...
        FAQ: "Частые вопросы",
        Contact: "Контакты",
        copyrights: "© Copyright Rimel 2022. Все права защищены",
