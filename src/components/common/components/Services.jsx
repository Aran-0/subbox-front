...
const Service = ({ icon, value, description }) => {
  return (
    <Box className="flex max-w-xs gap-6 items-center justify-center flex-col bg-gradient-to-br from-white to-gray-50 px-4 py-8 rounded-lg border border-gray-200 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
